...
export const firstLottery = new Date(Date.UTC(2021, 10, 26, 0, 0, 0, 0)); 
export const secondLottery = new Date(Date.UTC(2021, 10, 26, 1, 0, 0, 0)); 
export const thirdLottery = new Date(Date.UTC(2021, 10, 26, 2, 0, 0, 0)); 
export const forthLottery = new Date(Date.UTC(2021, 10, 29, 2, 0, 0, 0)); 
